...
float real time_position_x=0;//实时位置
float global_position_y=0;
float global_position_z=0;
float global_orientation_x=0;//实时朝向
float global_orientation_y=0;
float global_orientation_z=0;
float global_orientation_w=0;


void chatterCallback(const geometry_msgs::PoseStamped &msg)
{

    global_pose_x=msg.pose.position
...
int main(int argc, char **argv)
{
	...
	{ 
        ...
        myPoint2.pose.position.x = 4;//globalx+step;
