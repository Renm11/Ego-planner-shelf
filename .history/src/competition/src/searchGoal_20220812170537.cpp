...
int checktarget(geometry_msgs::PoseStamped &point1)
{
    if (abs(point.pose.position.x - realtime_position_x) < 0.5 && abs(point.pose.position.y - realtime_position_y) < 0.5)
    {
