...
{
     ROS_INFO_STREAM("I heard x: %f",msg.pose.position.x);
     ROS_INFO_STREAM("I heard y: %f", msg.pose.position.y);
     ROS_INFO_STREAM("I heard z: %f]",msg.pose.position.z);
}
...
int main(int argc, char **argv)
{
    ...
    // 点的坐标 
        ...
        myPoint2.pose.position.x = -6.0;
        myPoint2.pose.position.y = -6.0;
