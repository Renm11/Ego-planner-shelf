...
#include <geometry_msgs/PoeStamped.h>
...
int main(int argc, char **argv)
{
   ...
   // ros::Subscriber sub = n.subscribe("/odovisualization/pose", 1000, chatterCallback);
    ...
    // 点的坐标 
        ...
        myPoint2.pose.x = -3.0;
        myPoint2.point.y = -3.0;
        myPoint2.point.z = 1.0;
        // myPoint2.orientation.x=0;
        // myPoint2.orientation.y=0;
        // myPoint2.orientation.z=1;
        // myPoint2.orientation.w=0;
