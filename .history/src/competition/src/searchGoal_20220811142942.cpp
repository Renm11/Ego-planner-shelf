...
{
    printf("I heard x: %f",msg.pose.position.x);
    printf("I heard y: %f", msg.pose.position.y);
    printf("I heard z: %f]",msg.pose.position.z);
...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber sub = n.subscribe("/odomvisualization/pose", 1000, chatterCallback);
    ...
    // 点的坐标 
        ...
        myPoint2.pose.position.x = -10.0;
        myPoint2.pose.position.y = -10.0;
