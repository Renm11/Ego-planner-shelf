...
int main(int argc, char **argv)
{
    ...
    ros::Publisher chatter_pub = n.advertise<geometry_msgs::PoseStamped>("// ros::Publisher chatter_pub = n.advertise<geometry_msgs::PoseStamped>("/move_base_simple/goal", 1000);", 1000);
