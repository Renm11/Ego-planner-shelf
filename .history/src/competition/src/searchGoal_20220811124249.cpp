...
int main(int argc, char **argv)
{
   ...
   // ros::Subscriber sub = n.subscribe("/odovisualization/pose", 1000, chatterCallback);
    ...
    // 点的坐标 
        myPoint1.header.frame_id = "map";
        myPoint1.point.x = 3.0;
        myPoint1.point.y = 3.0;
        myPoint1.point.z = 1.0;
        myPoint1.pose.orientation.x=0;
        myPoint.pose.orientation.y=0;
        myPoint.pose.orientation.z=1;
        myPoint.pose.orientation.w=0;
